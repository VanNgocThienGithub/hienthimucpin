...
if "%PATH_GCCARM%"=="" (
  set OBJCOPY="D:\VanNgocThien\TailieuKhoaluantotnghiep\SiliconLabs\SimplicityStudio\v4\developer\toolchains\gnu_arm\7.2_2017q4\bin\arm-none-eabi-objcopy.exe"
) else (
...
if "%PATH_SCMD%"=="" (
  set COMMANDER="D:\VanNgocThien\TailieuKhoaluantotnghiep\SiliconLabs\SimplicityStudio\v4\developer\adapter_packs\commander\commander.exe"
) else (
